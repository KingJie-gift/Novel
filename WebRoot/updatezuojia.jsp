...
<div class="au_nav">
 ...
 <form action="checkServlet?op=updatebook" method="post"enctype="multipart/form-data">
<div class="au_create">
    <div class="au_box">
        <div class="au_c_con">
            <div class="au_c_tit">
            ...
            <div class="au_c_form">
                <ul>
                    ...
                    <li class="clear">
                        ...
                        <c:choose>
                        <c:when test="${novel.platform eq'纵横中文网'}">
                       ...
                       <c:otherwise>
                                                                          ...
                                                                          <em class="focus label">纵横中文网</em><input type="radio" value="纵横中文网" name="ra" class="pub_ico au_pointer" >                     
                                                                 <em class="label">花语女生网</em><input type="radio" value="花语女生网" name="ra" class="pub_ico au_pointer"  checked="checked">    
                       </c:otherwise>
                        </c:choose>
                   <li class="clear">
                    <div class="au_c_t fl"><em>*</em>是否完结：</div>
                        <div class="au_c_c fl radio_dom select_site_radio">
                        
                                                                          <em class="focus label">连载中</em><input type="radio" value="连载" name="state" class="pub_ico au_pointer" checked="checked" style="margin-left: 25px;">                     
                                                                 &nbsp;<em class="label">完结</em><input type="radio" value="完结" name="state" class="pub_ico au_pointer" style="margin-left: 40px;" >    
                        </div>
                        </li>
                    </li>
                    <li class="clear">
                    ...
                    <li class="clear selli">
                        ...
                        <div class="au_c_c fl">
                            <div class="au_select fl select_dom kindlist_ul">
                               ...
                               <c:if test="${novel.booktype!=bk.bookid}">
                               <option value="${bk.bookid}">${bk.booktype}</option>
                               
                               </c:if>
                               
                                        <c:if test="${novel.booktype==bk.bookid}">
                               <option value="${bk.bookid }" selected="selected">${bk.booktype}</option>
                    ...
                    <li class="clear">
                        ...
                        <div class="au_c_c fl">
                            <input type="text" placeholder="作品首字母" class="au_text bookstr"  id="firstLetter" maxlength="1" name="firstLetter" value="${novel.shouzimu}"/>
                    ...
                    <li class="clear">
                        ...
                        <div class="au_c_c fl">
                            ...
                            <div style="width: 330px; height: 50px">
                             <input type="text" name="guanjianzi"  value="${novel.booktitle}"class="akeys clear" style="width: 325px; height: 49px">
                            </div>
                            ...
                            <p class="au_tip">1-6个关键字</p>
                        </div>
                    </li>
                    <li class="clear">
                        <div class="au_c_t fl">原来封面：</div>
                    <div class="au_c_c fl">
                    
                          <!--  <input type="file"  id="fileId">-->
                     
                         <img  src="${novel.images}" style="height: 150px;width: 120px;margin-left: 7px;">
                    
                           <!--  <a href="javascript:;" class="upload greenbtn" id="pic">点击上传</a>--> 
                          <input   id="fileId" name="fileId" type="file"/>
                            <div style="margin-left: -76px;font-size: 15px;">当前封面：</div>
                            </div>
                            <div class="uploadarea">
                            
                          
                            <p class="au_cor_gay">1、只能上传规格为240*320像素的小于3MB的JPG图片</p>
                    ...
                    <li class="clear">
                        ...
                        <div class="au_c_c fl">
                            <div class="textarea">
                                <textarea placeholder="请在此输入作品简介" class="bookintro" maxlength="400" name="description" id="content">${novel.bookoutline}</textarea>
                                <em class="au_cor_gay">1-400位字符</em>
                    ...
                    <li class="clear">
                     <div class="au_c_t fl">作品寄语：</div>
                            ...
                            <div class="textarea">
                                <textarea placeholder="请在此输入作品寄语"  class="bookintro"  maxlength="20" name="wishWord">${novel.sendword}</textarea>
                                <em class="au_cor_gay">1-20位字符</em>
                               
                            </div>
                    
                            <div class="submitintro" style="margin-left: 126px;">
                            <input type="hidden" name="authorid" value="${authorid}">
                              <input type="submit" value="确定修改"class="nextstep greenbtn fl">
