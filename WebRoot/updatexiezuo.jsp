...
<form action="checkServlet?op=updatechapter" method="post">
<div class="pub_con_bg">
	<div class="manage">
    	...
    	<div class="side">
            ...
            <div class="articelist" id="artList" style="height:500px;overflow:auto;">
            <ul id="ul">
         <c:forEach items="${chapterlist}" var="c">
         <li onclick="searchchapter(${c.chapterid},`${c.chaptertitle}`)">${c.chaptertitle}</li>
         </c:forEach>
        ...
        <div class="wide" style="display:block;">
            ...
            <div class="coding">
                ...
                <div class="w_list clear">
                    <div class="minstar fl"></div>
                    <div class="w_con">
                    <input type="hidden" name="chapterid"  id="chapterid" value="${c.chapterid}">
                    <input type="hidden" name="bookid" value="${novel.bookid}">
                 
                    <input type="submit" value="修改章节" class="upload_c btn_bg">
...
$("form").submit(function(){
 ...
 function searchchapter(chapterid,chaptername){
   $("#chaptername").val();
   ...
   $("#chapterid").val(chapterid);
      $.ajax({
        "url" :"checkServlet",
         "type":"post",
         "data":"op=searchchapter&chapterid="+chapterid+"&bookid="+${novel.bookid}+"&authorid="+${au.authorid},
         "datatype":"json",
          "global":"false",
         "success":function(r){
